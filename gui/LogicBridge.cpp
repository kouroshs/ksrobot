...
{
    for(int i = 0; i < 5; i++)
        buttons[i] = new QPushButton("Button 1");
    
    connect(buttons[0], SIGNAL(clicked()), this, SLOT(b0));
    connect(buttons[1], SIGNAL(clicked()), this, SLOT(b1));
    connect(buttons[2], SIGNAL(clicked()), this, SLOT(b2));
    connect(buttons[3], SIGNAL(clicked()), this, SLOT(b3));
    connect(buttons[4], SIGNAL(clicked()), this, SLOT(b4));
}
