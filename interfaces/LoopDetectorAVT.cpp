...
#include <interfaces/LoopDetectorAVT.h>
#include <exception>
...
LoopDetectorAVT::LoopDetectorAVT() : common::LoopDetectorInterface() /*, mNumCandidateImages(DEFAULT_NUM_CANDIDATE_IMAGES), mUseFovisDescriptor(DEFAULT_USE_FOVIS_DESCRIPTOR),
...
{
    throw std::runtime_error("LoopDetectorAVT is no longer supported. use LoopDetectorRTABMAP instead.");
}

LoopDetectorAVT::~LoopDetectorAVT()
{
//     if( mCurrSceneDescriptor )
//         delete mCurrSceneDescriptor;
}

// void LoopDetectorAVT::ReadSettings(ProgramOptions::Ptr po)
// {
//     common::LoopDetectorInterface::ReadSettings(po);
...
// }
// 
// bool LoopDetectorAVT::RunSingleCycle()
// {
//     KeyframeData kd;
...
// }
// 
// void LoopDetectorAVT::ExtractImageKeypointDescriptors(const LoopDetectorAVT::KeyframeData& kd)
// {
//     cv::Mat desc;
...
// }
// 
// void LoopDetectorAVT::Extract3DPositions(const KeyframeData& kd, const std::vector<cv::KeyPoint>& keypoints)
// {
...
// }
// 
// void LoopDetectorAVT::ExtractSceneDescriptors()
// {
...
// }
// 
// bool LoopDetectorAVT::CheckForLoopClosure(int candidate, Eigen::Isometry3f& transform)
// {
...
// }
// 
// void LoopDetectorAVT::ExtractValidMatches(const std::vector<cv::DMatch>& matches, const PointArray& prev, const PointArray&curr, 
...
// }
// 
// void LoopDetectorAVT::MatchFeatures(int candidate, std::vector<cv::DMatch>& matches)
// {
...
// }
// 
// bool LoopDetectorAVT::Ransac(const PointArray& prev_points, const PointArray& curr_points, 
...
// }
// 
// bool LoopDetectorAVT::ComputeHornTransform(const PointArray& prev_points, const PointArray& curr_points,
...
// }
// 
// bool LoopDetectorAVT::IsInlier(const Eigen::Vector3f& prev, const Eigen::Vector3f& curr, const Eigen::Isometry3f& transform)
// {
//     return (curr - transform * prev).squaredNorm() <= mRansacInlierMaxSquaredDist;
// }
// 
// float LoopDetectorAVT::ComputeError(const PointArray& prev_points, const PointArray& curr_points, const std::vector<cv::DMatch>& matches,
